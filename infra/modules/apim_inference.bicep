...
resource api 'Microsoft.ApiManagement/service/apis@2024-06-01-preview' = {
  ...
  properties: {
    ...
    type: 'http'
    value: string((inferenceAPIType == 'AzureOpenAI') ? loadJsonContent('./specs/azureaifoundryopenai.json') : (inferenceAPIType == 'AzureAI') ? loadJsonContent('./specs/azureaifoundry.json') : (inferenceAPIType == 'OpenAI') ? loadJsonContent('./specs/azureaifoundry.json') : loadJsonContent('./specs/passthrough.json'))
  }
}
